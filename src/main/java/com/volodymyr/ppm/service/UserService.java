...
public interface UserService {
    TokenDto login(String login, String password, String remoteAddr, String userAgent, String sessionId) throws QrGenerationException;
    TokenDto renewToken(Token token, String remoteAddr, String userAgent, String sessionId) throws QrGenerationException;
    ...
    MessageDto changePassword(Token token, String remoteAddr, String userAgent, String sessionId, String newPwd, String oldPwd) throws QrGenerationException;
