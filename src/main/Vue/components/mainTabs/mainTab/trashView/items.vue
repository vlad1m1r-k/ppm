        ...
        <div v-show="showNotes">
            <table class="table">
                ...
                <tr>
                    ...
                    <th><button class="btn link" @click="setNotesSort('name')">{{ language.data.div1 }}</button></th>
                    <th><button class="btn link" @click="setNotesSort('createdDate')">{{ language.data.div2 }}</button></th>
                    <th><button class="btn link" @click="setNotesSort('createdBy')">{{ language.data.div3 }}</button></th>
                    <th><button class="btn link" @click="setNotesSort('editedDate')">{{ language.data.div4 }}</button></th>
                    <th><button class="btn link" @click="setNotesSort('editedBy')">{{ language.data.div5 }}</button></th>
                    <th><button class="btn link" @click="setNotesSort('deletedDate')">{{ language.data.div6 }}</button></th>
                    <th><button class="btn link" @click="setNotesSort('deletedBy')">{{ language.data.div7 }}</button></th>
                    <th></th>
                    <th></th>
                </tr>
                </thead>
        ...
        <div v-show="showPass">
            <table class="table">
                ...
                <tr>
                    ...
                    <th><button class="btn link" @click="setPwdSort('name')">{{ language.data.div1 }}</button></th>
                    <th><button class="btn link" @click="setPwdSort('createdDate')">{{ language.data.div2 }}</button></th>
                    <th><button class="btn link" @click="setPwdSort('createdBy')">{{ language.data.div3 }}</button></th>
                    <th><button class="btn link" @click="setPwdSort('editedDate')">{{ language.data.div4 }}</button></th>
                    <th><button class="btn link" @click="setPwdSort('editedBy')">{{ language.data.div5 }}</button></th>
                    <th><button class="btn link" @click="setPwdSort('deletedDate')">{{ language.data.div6 }}</button></th>
                    <th><button class="btn link" @click="setPwdSort('deletedBy')">{{ language.data.div7 }}</button></th>
                    <th></th>
                    <th></th>
                </tr>
                </thead>
        ...
        <div v-show="showFls">
            <table class="table">
                ...
                <tr>
                    ...
                    <th><button class="btn link" @click="setFlsSort('name')">{{ language.data.div1 }}</button></th>
                    <th><button class="btn link" @click="setFlsSort('size')">{{ language.data.div8 }}</button></th>
                    <th><button class="btn link" @click="setFlsSort('createdDate')">{{ language.data.div2 }}</button></th>
                    <th><button class="btn link" @click="setFlsSort('createdBy')">{{ language.data.div3 }}</button></th>
                    <th><button class="btn link" @click="setFlsSort('editedDate')">{{ language.data.div4 }}</button></th>
                    <th><button class="btn link" @click="setFlsSort('editedBy')">{{ language.data.div5 }}</button></th>
                    <th><button class="btn link" @click="setFlsSort('deletedDate')">{{ language.data.div6 }}</button></th>
                    <th><button class="btn link" @click="setFlsSort('deletedBy')">{{ language.data.div7 }}</button></th>
                    <th></th>
                    <th></th>
                </tr>
                </thead>
